...
const ReferencePage = () => import('@/containers/InvestmentPage/ReferencePage')

const InterestPage = () => import('@/containers/InvestmentPage/InterestPage')
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'interest', name: 'interest-page', component: InterestPage },
        { path: 'reference', name: 'reference-page', component: ReferencePage }
      ],
      meta: {
        auth: true
      }
