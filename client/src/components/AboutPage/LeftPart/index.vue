    ...
    data() {
        return {
            items:[
                ...
                { title: 'Careers', link: '/our-company' },
                { title: 'Our History', link: '/our-company' },
                { title: 'Our Investment', link: '/our-company' },
                { title: 'Partners', link: '/our-company' },
                { title: 'Our Team', link: '/our-company' }
            ],
            carouselItems:[
