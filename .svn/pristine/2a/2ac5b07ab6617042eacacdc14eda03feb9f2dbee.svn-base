<template>
    <div class="form-login">
        <v-form v-model="valid" ref="loginForm">
            ...
            <v-text-field label="Username or Email" v-model="username" :rules="usernameRules" :counter="6" required></v-text-field>
            ...
            <div class="form-login-footer">
                ...
                <v-btn v-tooltip:bottom="{ html: 'Please send an email to admin to request a new password!' }" primary outline class="flex">Forgot Password?</v-btn>
            </div>
        </v-form>
    </div>
</template>
